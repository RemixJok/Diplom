...
namespace Diplom.Страницы.Общие
{
    ...
    public partial class ChangeUserInfo : Page
    {
        ...
        private void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            //лучше ограничить кол-во символов в самом textbox
            ...
            if (_currentUser.ID_Пользователя == 0) //самый первый пользователь имеет ID == 0. некорректно. неверно имел ввиду null?
